...
app.post("/employees", async (req, res) => {
    try {
      ...
      const newEmployee = await pool.query(
        "INSERT INTO employee (Name, Department, Designation, salary, dob, address, age) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *",
        [name, department, designation, salary, dob, address, age]
      );
  ...
  app.put("/employees/:id", async (req, res) => {
    try {
      ...
      const updateEmployee = await pool.query(
        "UPDATE employee SET name = $1, department = $2, designation = $3, salary = $4, dob = $5, address = $6 age = $8 WHERE emp_id = $7",
        [name, department, designation, salary, dob, address, id, age]
      );
